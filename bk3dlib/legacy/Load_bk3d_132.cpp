...
#   undef Mapbk3dMatTD
#endif
typedef bk3d132::Transform          bk3dTransform;
typedef bk3d132::FileHeader         bk3dFileHeader;
typedef bk3d132::FloatArrayPool::Connection bk3dFloatArrayPoolConnection;
typedef bk3d132::FloatArray         bk3dFloatArray;
typedef bk3d132::FloatArrayPool     bk3dFloatArrayPool;
typedef bk3d132::PrimGroup          bk3dPrimGroup;
typedef bk3d132::Mesh               bk3dMesh;
typedef bk3d132::Attribute          bk3dAttribute;
typedef bk3d132::Material           bk3dMaterial;
typedef bk3d132::MayaCurveVector    bk3dMayaCurveVector;
typedef bk3d132::MayaCurve          bk3dMayaCurve;
typedef Mapbk3dTransf132            Mapbk3dTransfTD;
typedef Mapbk3dMat132               Mapbk3dMatTD;

#define BK3DLOAD bk3d132::load
#define READBK3DFILE ReadBk3dFile_132
...
{
	if(pC->pTarget == pbk3dTransf->pos)
		return bk3dlib::TRANSF_POS;
	if(pC->pTarget == pbk3dTransf->scale)
		return bk3dlib::TRANSF_SCALE;
	if(pC->pTarget == pbk3dTransf->rotation)
		return bk3dlib::TRANSF_EULERROT;
	//if(pC->pTarget == pbk3dTransf->)
...
bool CFileHeader::READBK3DFILE(bk3dFileHeader *pHeader)
{
	...
	if(fileHeaderSrc->pTransforms)
	{
		for(int i=0; i<fileHeaderSrc->pTransforms->n; i++)
		{
            ...
            CBone* p = NULL;
            p =new CTransform((bk3d132::Transform *)fileHeaderSrc->pTransforms->p[i]);
 ...
 */
bool		CFileHeader::LoadFromBk3dFile_132(LPCSTR file)
{
	bk3dFileHeader *pData = static_cast<bk3dFileHeader *>(BK3DLOAD(file));
	if(!pData)
		return NULL;//LoadFromBk3dFile_131(file);
