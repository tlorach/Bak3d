...
// glTexImage3DEXT(GL_TEXTURE_3D, 0, image.get_components(), image.get_width(), 
//     image.get_height(), image.get_depth(), 0, image.get_format(), 
//     GL_UNSIGNED_BYTE, image);
// 
// for (int i = 0; i < image.get_num_mipmaps(); i++)
// {
//     glTexImage3DEXT(GL_TEXTURE_3D, i+1, image.get_components(), 
...
bool CDDSImage::upload_texture1D()
{
    ...
    if (is_compressed())
    {
        ...
        //{
        //    GET_EXT_POINTER(glCompressedTexImage1D, 
...
bool CDDSImage::upload_texture3D()
{
    ...
    else
    {
        ...
        glTexImage3DEXT(GL_TEXTURE_3D, 0, m_components, baseImage.get_width(), 
        ...
        for (unsigned int i = 0; i < baseImage.get_num_mipmaps(); i++)
        {
            ...
            glTexImage3DEXT(GL_TEXTURE_3D, i+1, m_components, 
